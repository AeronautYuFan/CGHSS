...
with open(file_path, mode='r') as file:
    ...
    # Add edges based on instruments, years, and schools with colors
    edge_colors = []
...
edges = G.edges()
nx.draw(G, with_labels=True, node_color='lightblue', node_size=2000, font_size=10, font_color='black', font_weight='bold', edge_color=edge_colors)
plt.title("Graph of Students by Instrument, Year, and School with Colored Edges")
...
plt.savefig(os.path.join('graphs', "students_graph.png"), format="png", bbox_inches='tight')
